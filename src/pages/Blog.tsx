        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Dante Labs News &amp; Insights
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              The latest trends and news in Dante Labs Products
            </p>
          </div>
        </div>
      </div>
            ...
            Array.from({ length: Math.max(0, 4 - blogPosts.length) }).map(
              (_, index) => (
                <BlogPostCard
                  ...
                  excerpt="Stay tuned for more exciting articles about Dante Labs Products."
                  imageUrl={
                    index % 2 === 0
                      ? "https://i.ibb.co/YnBSDkC/Dantelabs.webp"
                      : "https://i.ibb.co/YnBSDkC/Dantelabs.webp"
                  }
                  date="Coming soon"
                  slug="#"
