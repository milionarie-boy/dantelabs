        ...
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              >
                Explore the technical foundation behind our blockchain
                architecture and learn how our system enables secure, scalable,
                and rapid deployment of decentralized solutions.
              </motion.p>
              ...
              >
                ...
                <p className="text-gray-600 mb-8 text-base max-w-3xl">
                  ...
                  on-chain smart contracts, off-chain services, and user-facing
                  applications. The diagram below illustrates how data flows
                  through the system — from blockchain transactions to
              ...
              >
                ...
                <p className="text-gray-600 mb-8 text-base max-w-3xl">
                  At DanteLabs Blockchain, we combine deep technical innovation
                  with real-world use cases. Our structured development process
                  ensures every project advances efficiently from concept →
                  testnet → mainnet → market-ready product.
                </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "We begin with thorough tokenomics research, ecosystem analysis, and compliance mapping to align with client goals.",
                    },
                    {
                      title: "Design & Prototyping",
                      icon: <Code className="w-5 h-5 text-gray-700" />,
                      description:
                        "Our teams create smart contract prototypes, token models, and initial dApp mockups for early feedback.",
                    },
                    {
                      title: "Development & Testing",
                      icon: <FileText className="w-5 h-5 text-gray-700" />,
                      description:
                        "We rigorously develop, audit, and test smart contracts and supporting infrastructure to ensure security, scalability, and regulatory compliance.",
                    },
                  ].map((phase, i) => (
                    <motion.div
                      key={phase.title}
