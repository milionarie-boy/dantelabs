        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <Link to="/" className="flex items-center">
              <img
                src="https://i.ibb.co/yBNQb6tz/dantelabs-title.png"
                alt="Dante Labs Logo"
                className={cn(
                  "h-8 w-auto",
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul className="grid gap-3 p-4 w-[400px]">
                      <li>
                        <Link
                          to="/projects/cryptoskope"
                          className="block p-3 space-y-1 rounded-md hover:bg-gray-100"
                        >
                          <div className="font-medium">CryptoSkope</div>
                      ...
                      <li>
                        <Link
                          to="/projects/gamechain"
                          className="block p-3 space-y-1 rounded-md hover:bg-gray-100"
                        >
                          <div className="font-medium">Gamechain Studios</div>
                          <p className="text-sm text-gray-500">
                            Play-to-Earn Gaming Echosystem
                          </p>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-500">
                            Supply chain transparency platform with loT
                            integration
                          </p>
                        </Link>
                      </li>
                      <li>
                        <Link
                          ...
                          className="block p-3 space-y-1 rounded-md hover:bg-gray-100"
                        >
                          <div className="font-medium">Decentral DAO</div>
                          <p className="text-sm text-gray-500">
                    ...
                    <ul className="grid gap-3 p-4 w-[400px]">
                      <li>
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-500">
                            How our Dante Labs Service works
                          </p>
                        </Link>
                      </li>
                      <li>
