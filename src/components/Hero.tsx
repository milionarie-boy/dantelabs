          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            ...
            >
              <motion.h1
                ...
                variants={itemVariants}
              >
                Leading Dapp Development Agency
              </motion.h1>
              <motion.p
                className="banner-subtitle text-gray-300 mt-4 sm:mt-6"
                variants={itemVariants}
              >
                We build cutting-edge decentralized applications on blockchain
                platforms like Ethereum, Solana, and Polygon.
              </motion.p>
              <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Secure and efficient smart contracts that power your decentralized
              applications.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Seamless integration with wallets, DeFi protocols, and blockchain
              infrastructure.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Build on multiple blockchains including Ethereum, Solana, Polygon,
              and more.
            </p>
          </motion.div>
        </motion.div>
