    ...
    >
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            In a blockchain world where overengineering leads to failed
            launches, we deliver streamlined solutions and deep expertise to
        ...
        >
          ...
          >
            ...
            <p className="text-gray-700">
              Blockchain market projected to hit this value by 2030, with huge
              growth potential for decentralized applications and Web3
              solutions.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              of blockchain projects stall at the proof-of-concept stage due to
              fragmented expertise, poor coordination, and lack of scalable
              architecture.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              Increase in time-to-market for blockchain applications over the
              past four years, causing costly delays and missed market
              opportunities.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              What DanteLabs Does for You
            </h3>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We transform your ideas into digital solutions with tangible
