...
const projects = [
  {
    ...
    brand: "DECENTRALDAO",
    description:
      "Comprehensive governance platform with proposal systems, weighted voting, treasury management, and delegation mechanisms.",
    tags: ["DAO", "Governance", "Voting", "Treasury"],
    imageUrl: "https://i.ibb.co/SXF06sQD/daoimage-modified.png",
    link: "/projects/governance",
  },
  {
    id: 2,
    title: "NFT Gaming Marketplace",
    brand: "GAMECHAIN STUDIOS",
    description:
      "Play-to-earn gaming ecosystem with NFT marketplace, in-game asset trading, and cross-game item interoperability.",
    tags: ["Gaming", "NFTs", "P2E", "Marketplace"],
    imageUrl: "https://i.ibb.co/hFGsp45Y/Metahorse.png",
    link: "/projects/gamechain",
  },
  {
    id: 3,
    ...
    brand: "CRYPTOSKOPE",
    description:
      "Full-stack decentralized exchange with automated market makers, liquidity mining, and cross-chain asset swapping capabilities.",
    tags: ["DeFi", "AMM", "Cross-Chain", "Trading"],
    imageUrl: "https://i.ibb.co/BvqMd6T/crypto-Skope-modified.png",
    link: "/projects/cryptoskope",
  },
  {
    id: 4,
    title: "Enterprise Blockchain Solution",
    brand: "TECHCORP INTERNATIONAL",
    description:
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-3">From Code to Blockchain</h2>
          <p className="text-gray-600">
            Explore how our blockchain development expertise is transforming
            industries with innovative dapp solutions tailored to specific
            business needs.
          </p>
          {isMobile && (
