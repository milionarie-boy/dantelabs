...
const Features = () => {
  ...
  const features = [
    {
      ...
      description:
        "Build decentralized finance protocols with automated market makers, lending platforms, and yield farming solutions.",
      image: "https://i.ibb.co/8nd4krKr/defi-image.jpg",
    },
    {
      icon: (
      ...
      title: "Gaming & NFTs",
      description:
        "Create blockchain-based games with NFT marketplaces, play-to-earn mechanics, and digital asset trading.",
      image: "https://i.ibb.co/hFGsp45Y/Metahorse.png",
    },
    {
      icon: (
      ...
      description:
        "Custom blockchain applications for supply chain management, identity verification, and corporate tokenization.",
      image: "https://i.ibb.co/Qvnn7sT9/enterprise-Solutionjfif.jpg",
    },
    {
      icon: (
      ...
      description:
        "Seamless interoperability solutions connecting multiple blockchain networks for enhanced functionality.",
      image: "https://i.ibb.co/F4czZyLw/crosschain.jpg",
    },
  ];
  ...
  const sensorCaseStudies = [
    {
      image: "https://i.ibb.co/BvqMd6T/crypto-Skope-modified.png",
      title: "DeFi Trading Platform",
      description:
        "Automated market maker with liquidity pools, yield farming, and advanced trading features for crypto assets.",
    },
    {
      image: "https://i.ibb.co/gM4bYvgS/Metahorsea.png",
      title: "NFT Marketplace",
      description:
        "Full-featured marketplace for digital collectibles with minting, trading, and royalty distribution systems.",
    },
    {
      image: "https://i.ibb.co/60LLqZKT/daoimage-modified-2.png",
      title: "DAO Governance",
      description:
        "Decentralized autonomous organization platform with voting mechanisms, and proposal systems.",
    },
  ];
  const stepFlowItems = [
    {
      ...
      description:
        "Custom smart contracts built with security and efficiency as core principles",
    },
    {
      icon: <Factory className="h-10 w-10 text-gray-700" />,
      title: "Frontend Integration",
      description:
        "Modern web3 interfaces with seamless wallet connectivity and user experience",
    },
    {
      icon: <Handshake className="h-10 w-10 text-gray-700" />,
      title: "Blockchain Deployment",
      description:
        "Multi-chain deployment and optimization for maximum reach and performance",
    },
  ];
  const sprintPhases = [
    {
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8" ref={featuresRef}>
          <div className="text-center mb-10 max-w-3xl mx-auto feature-item">
            ...
            <p className="text-gray-600 mt-4">
              Our blockchain development expertise covers the full spectrum of
              decentralized applications, from DeFi protocols to NFT
              marketplaces and enterprise solutions.
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                >
                  ...
                  {!isHijacked && (
                    <div
                      className={`h-0.5 bg-white/70 mt-3 transition-all duration-500 ${hoveredFeature === index ? "w-full" : "w-0"}`}
                    ></div>
                  )}
                </div>
              </div>
          ...
          <div className="mt-16 mb-8 feature-item">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold">Real-World Projects</h3>
              <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
                Explore our blockchain development portfolio spanning DeFi,
                NFTs, and enterprise solutions across multiple chains and use
                cases.
            ...
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              ...
              <div className="text-center mt-6 text-sm text-gray-600">
                <p className="font-medium">
                  These examples showcase just a few ways our blockchain
                  expertise can revolutionize your industry
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              DanteLabs combines cutting-edge smart contract development with
              modern frontend technologies, delivering secure and scalable
              decentralized applications across multiple blockchain networks.
            </p>
          </div>
